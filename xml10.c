    ...
    Marpa_Grammar g;
{
    ...
    /* Populate the rules */
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_document].symbolId , 3, &(aXml10SymbolId[0]));
    }
    {
        /* Char ::= CHAR */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Char].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_SystemLiteral].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* Reference ::= EntityRef */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Reference].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* Reference ::= CharRef */
        Marpa_Symbol_ID rhsIds[] = {
    ...
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_EntityRef].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_PEReference].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* EntityDecl ::= GEDecl */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_EntityDecl].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* EntityDecl ::= PEDecl */
        Marpa_Symbol_ID rhsIds[] = {
    ...
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_GEDecl].symbolId , 7, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_PEDecl].symbolId , 9, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_EntityDef].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
    ...
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_PubidLiteral].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_EntityDef].symbolId , 2, &(aXml10SymbolId[0]));
    }
    {
        /* PEDef ::= EntityValue */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_PEDef].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* PEDef ::= ExternalID */
        Marpa_Symbol_ID rhsIds[] = {
    ...
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_ExternalID].symbolId , 3, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_ExternalID].symbolId , 5, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_NDataDecl].symbolId , 4, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_TextDecl].symbolId , 5, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_extParsedEnt].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_extParsedEnt].symbolId , 2, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_EncodingDecl].symbolId , 6, &(aXml10SymbolId[0]));
    }
    {
        /* CharData ::= CHARDATA */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_CharData].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
    ...
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_EncName].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_NotationDecl].symbolId , 7, &(aXml10SymbolId[0]));
    }
    {
    ...
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_PublicID].symbolId , 3, &(aXml10SymbolId[0]));
    }
    {
        /* x20 ::= X20 */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_x20].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_XMLDeclMaybe].symbolId , 1, &(aXml10SymbolId[0]));
    }
    { /* XMLDeclMaybe ::= */
    ...
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_MiscAny].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_EncodingDeclMaybe].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Comment].symbolId , 3, &(aXml10SymbolId[0]));
    }
    { /* EncodingDeclMaybe ::= */
    ...
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_SDDeclMaybe].symbolId , 1, &(aXml10SymbolId[0]));
    }
    { /* SDDeclMaybe ::= */
    ...
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_SMaybe].symbolId , 1, &(aXml10SymbolId[0]));
    }
    { /* SMaybe ::= */
    ...
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_ContentInterior].symbolId , 2, &(aXml10SymbolId[0]));
    }
    {
    ...
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_PITarget].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_ContentInteriorAny].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_intSubsetUnit].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
    ...
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_intSubsetUnitAny].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_extSubsetDeclUnit].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
    ...
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_extSubsetDeclUnitAny].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_STagInterior].symbolId , 2, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_STagInteriorAny].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_PI].symbolId , 3, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_CharDataMaybe].symbolId , 1, &(aXml10SymbolId[0]));
    }
    { /* CharDataMaybe ::= */
    ...
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_EmptyElemTagInterior].symbolId , 2, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_EmptyElemTagInteriorAny].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Quantifier].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* Quantifier ::= Star */
        Marpa_Symbol_ID rhsIds[] = {
    ...
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_QuantifierMaybe].symbolId , 1, &(aXml10SymbolId[0]));
    }
    { /* QuantifierMaybe ::= */
    ...
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_ChoiceInterior].symbolId , 4, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_PI].symbolId , 5, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_ChoiceInteriorMany].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_SeqInterior].symbolId , 4, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_SeqInteriorAny].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_MixedInterior].symbolId , 4, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_MixedInteriorAny].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* AttDefAny ::= AttDef * */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_AttDefAny].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_NotationTypeInterior].symbolId , 4, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_NotationTypeInteriorAny].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_EnumerationInterior].symbolId , 4, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_EnumerationInteriorAny].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_CDSect].symbolId , 3, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_ignoreSectContentsAny].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_ignoreSectContentsInterior].symbolId , 4, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_ignoreSectContentsInteriorAny].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_VersionInfoMaybe].symbolId , 1, &(aXml10SymbolId[0]));
    }
    { /* VersionInfoMaybe ::= */
    ...
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_WhiteSpace].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_CommentBeg].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_CommentEnd].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_CommentInterior].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_PiInterior].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* CDStart ::= CDSTART */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_CDStart].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* XmlBeg ::= XML_BEG */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_XmlBeg].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* XmlEnd ::= XML_END */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_XmlEnd].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* Version ::= VERSION */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Version].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* Squote ::= SQUOTE */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Squote].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* Dquote ::= DQUOTE */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Dquote].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* Equal ::= EQUAL */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Equal].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_DoctypeBeg].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* DoctypeEnd ::= XTagEnd */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_DoctypeEnd].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* Lbracket ::= LBRACKET */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Lbracket].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* Rbracket ::= RBRACKET */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Rbracket].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* CData ::= CDATA */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_CData].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Standalone].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* Yes ::= YES */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Yes].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* No ::= NO */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_No].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* XTagBeg ::= XTAG_BEG */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_XTagBeg].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* STagBeg ::= XTagBeg */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_STagBeg].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* XTagEnd ::= XTAG_END */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_XTagEnd].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* STagEnd ::= STAG_END */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_STagEnd].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* ETagBeg ::= ETAG_BEG */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_ETagBeg].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* ETagEnd ::= ETAG_END */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_ETagEnd].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_EmptyElemTagBeg].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* Name ::= NAME */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Name].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* CDEnd ::= CDEND */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_CDEnd].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_EmptyElemTagEnd].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_ElementDeclBeg].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_ElementDeclEnd].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* Empty ::= EMPTY */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Empty].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* Any ::= ANY */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Any].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_QuestionMark].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* Star ::= STAR */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Star].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* Plus ::= PLUS */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Plus].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* Lparen ::= LPAREN */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Lparen].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* Rparen ::= RPAREN */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Rparen].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_prolog].symbolId , 2, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_RparenStar].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* Pipe ::= PIPE */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Pipe].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* Comma ::= COMMA */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Comma].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_AttlistBeg].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* AttlistEnd ::= XTagEnd */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_AttlistEnd].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* TypeId ::= TYPE_ID */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_TypeId].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_TypeIdref].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_TypeIdrefs].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_TypeEntity].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_TypeEntities].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_prolog].symbolId , 4, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_TypeNmtoken].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_TypeNmtokens].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* Notation ::= NOTATION */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Notation].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_NotationBeg].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* NotationEnd ::= XTagEnd */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_NotationEnd].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* Required ::= REQUIRED */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Required].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* Implied ::= IMPLIED */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Implied].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* Fixed ::= FIXED */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Fixed].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* SectBeg ::= SECT_BEG */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_SectBeg].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* SectEnd ::= SECT_END */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_SectEnd].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_XMLDecl].symbolId , 6, &(aXml10SymbolId[0]));
    }
    {
        /* Include ::= INCLUDE */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Include].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* EdeclBeg ::= EDECL_BEG */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_EdeclBeg].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* EdeclEnd ::= XTagEnd */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_EdeclEnd].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* Percent ::= PERCENT */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Percent].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* System ::= SYSTEM */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_System].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* Public ::= PUBLIC */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Public].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* Ndata ::= NDATA */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Ndata].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* Encoding ::= ENCODING */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Encoding].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* TOKIgnore ::= IGNORE */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_TOKIgnore].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* Pcdata ::= PCDATA */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Pcdata].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_VersionInfo].symbolId , 6, &(aXml10SymbolId[0]));
    }
    {
        /* PiBeg ::= PI_BEG */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_PiBeg].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* PiEnd ::= PI_END */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_PiEnd].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* :start ::= document */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10___start_].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
    ...
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Eq].symbolId , 3, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_VersionNum].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* Misc ::= Comment */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Misc].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* Misc ::= PI */
        Marpa_Symbol_ID rhsIds[] = {
    ...
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Names].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* Misc ::= WhiteSpace */
        Marpa_Symbol_ID rhsIds[] = {
    ...
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_doctypedecl].symbolId , 5, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_doctypedecl].symbolId , 9, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_doctypedecl].symbolId , 7, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_doctypedecl].symbolId , 11, &(aXml10SymbolId[0]));
    }
    {
        /* DeclSep ::= PEReference */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_DeclSep].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* DeclSep ::= WhiteSpace */
        Marpa_Symbol_ID rhsIds[] = {
    ...
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_intSubset].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_markupdecl].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
    ...
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Names].symbolId , 2, &(aXml10SymbolId[0]));
    }
    {
    ...
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_extSubset].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_extSubset].symbolId , 2, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_extSubsetDecl].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_SDDecl].symbolId , 6, &(aXml10SymbolId[0]));
    }
    {
    ...
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Nmtoken].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
    ...
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_element].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_element].symbolId , 3, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_STag].symbolId , 5, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Attribute].symbolId , 3, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_ETag].symbolId , 4, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_content].symbolId , 2, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_EmptyElemTag].symbolId , 5, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_elementdecl].symbolId , 7, &(aXml10SymbolId[0]));
    }
    {
        /* contentspec ::= Empty */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_contentspec].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* Nmtokens ::= Nmtoken */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Nmtokens].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* contentspec ::= Any */
        Marpa_Symbol_ID rhsIds[] = {
    ...
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_children].symbolId , 2, &(aXml10SymbolId[0]));
    }
    {
    ...
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_cp].symbolId , 2, &(aXml10SymbolId[0]));
    }
    {
    ...
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_choice].symbolId , 6, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_seq].symbolId , 6, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Nmtokens].symbolId , 2, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Mixed].symbolId , 6, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Mixed].symbolId , 5, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_AttlistDecl].symbolId , 6, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_AttDef].symbolId , 6, &(aXml10SymbolId[0]));
    }
    {
        /* AttType ::= StringType */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_AttType].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
    ...
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_StringType].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_TokenizedType].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
    ...
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_EntityValue].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
    ...
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_EnumeratedType].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
    ...
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_NotationType].symbolId , 8, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Enumeration].symbolId , 6, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_DefaultDecl].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* AttValue ::= ATTVALUE */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_AttValue].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* DefaultDecl ::= Implied */
        Marpa_Symbol_ID rhsIds[] = {
    ...
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_DefaultDecl].symbolId , 3, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_conditionalSect].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
    ...
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_includeSect].symbolId , 7, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_ignoreSect].symbolId , 7, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_ignoreSectContents].symbolId , 2, &(aXml10SymbolId[0]));
    }
    {
        ...
        _fillRule(g, aXml10SymbolId[XML10_Ignore].symbolId , 1, &(aXml10SymbolId[0]));
    }
    {
        /* CharRef ::= CHARREF */
        Marpa_Symbol_ID rhsIds[] = {
        ...
        _fillRule(g, aXml10SymbolId[XML10_CharRef].symbolId , 1, &(aXml10SymbolId[0]));
    }
}
